...
from GUI.Window.Main_Window.Main_Window_Processing.main_window_processing_frame_input_data import \
    MainWindowProcessingFrameInputData
from GUI.Window.Main_Window.Main_Window_Visualisations.main_window_visualisation_frame import \
    create_main_window_visualisation_frame

from GUI.Window.Main_Window.main_window_size import define_main_window_size
from GUI.Widgets.Separators.processing_visualization_separator import create_processing_visualization_separator
from GUI.Widgets.Separators.buttons_separator import create_button_separator

from GUI.Window.Main_Window.Main_Window_Processing.main_window_processing_frame_call import \
    call_main_window_processing_frames

from GUI.Widgets.Buttons.Buttons_Processing.choose_wav_file_button_to_process import \
    define_choose_wav_file_to_process_button
from GUI.Widgets.Buttons.Buttons_Processing.process_wav_file_button import define_process_wav_file_button
from GUI.Widgets.Buttons.Buttons_File_Explorer.open_last_selected_directory_button import \

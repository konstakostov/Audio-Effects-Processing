...
If there has been selected .wav file by the user then it will open it's directory, otherwise it will raise and error 
...
def open_last_directory_button_functionality():
    if VariableStorage.file_path_selected_wav_file:
        ...
        if platform.system() == "Windows":
            ...
            subprocess.Popen(['xdg-open', last_directory_path])
    else:

...
from Windows_Version.GUI.Widgets.Spinboxes.main_spinbox import MainSpinbox
from Windows_Version.GUI.Window.Top_Window_Parameters.Top_Window_Parameters_Functions.save_effect_parameters_function import save_effect_parameters
